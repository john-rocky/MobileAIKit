...
/// so scaffolds should start from ``Entry/recommended`` and prune what they don't use.
///
...
public enum PrivacyKeys {
    ...
    public static func plistFragment(from entries: [Entry] = Entry.recommended) -> [String: String] {
